      ...
      for (int i = 0; i < mods.length; i++) {
        ...
        switch (thisMod) {
            ...
            case "rotate_arbitrary":
              ...
              break;
            case "ditherMap64":
                  image.runThresholdMap64(false);
                  break;
            case "threshold_dither":
//                image.all(Pixel::thresholdDither);
//                image.threshold();
//                image.ditherBW();
//                image.ditherColor();
                image.ditherBW2D();
                break;
            case "colorDitherMap64":
                image.runThresholdMap64(true);
                break;
            case "halftone":
                image.runThresholdMap9();
                break;
            case "convert16":
                image.ColorConversion16();
                break;
            case "errorDiffuse1D":
                image.errorDiffusion1D();
                break;
            case "errorDiffuse1DColor":
                image.errorDiffusion1DColor();
                break;
            case "errorDiffuse2D":
                image.errorDiffusion2D();
                break;
            case "errorDiffuse2DColor":
                image.errorDiffusion2DColor();
                break;
            case "outline":
                image.outline();
                break;
            case "kernelOutline":
                image.applyKernelOutline();
                break;
            case "dotHalftone5":
                image.dotHalftone5Dot();
                break;
            case "dotHalftone3":
                image.dotHalftone3Dot();
                break;
            case "massiveHalftone":
                image.massiveHalftone();
                break;
            case "euclideanThreshold":
                image.euclideanThreshold();
                break;
            case "color_reduce_ml":
                image.colorReduceML();
                break;
            case "color_reduce":
                image.colorReduce();
                break;
            case "color_reduce_vga":
                image.colorReduceVGA();
                break;
            case "color_reduce_html":
                image.colorReduceHTML();
                break;
            case "greenscreen":
                image.greenScreen();
                break;
